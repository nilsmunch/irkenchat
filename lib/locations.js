locations = [
  ...
  {
    name: 'locations.deathstar',
    roles: [
      'locations.roles.deathstar.darth vader',
      'locations.roles.deathstar.emperor',
      'locations.roles.deathstar.rebels',
      'locations.roles.deathstar.princess',
      'locations.roles.deathstar.jedi master',
      'locations.roles.deathstar.xwing pilot',
      'locations.roles.deathstar.stormtrooper'
    ]
  },
  {
    name: 'locations.comicon',
    roles: [
      'locations.roles.comicon.stan lee',
      'locations.roles.comicon.cosplayer',
      'locations.roles.comicon.comic book artist',
      'locations.roles.comicon.actor',
      'locations.roles.comicon.voice actor',
      'locations.roles.comicon.nathan fillon',
      'locations.roles.comicon.fan'
    ]
  },
  {
    ...
    roles: [
      ...
      'locations.roles.prison.chef',
      'locations.roles.prison.gang leader',
      'locations.roles.prison.escape artist',
      'locations.roles.prison.psychologist',
      'locations.roles.prison.inmate'
    ]
  },
  {
    name: 'locations.funeral',
    roles: [
      'locations.roles.funeral.widow',
      'locations.roles.funeral.priest',
      'locations.roles.funeral.gravedigger',
      'locations.roles.funeral.lawyer',
      'locations.roles.funeral.polebearer',
      'locations.roles.funeral.coroner',
      'locations.roles.funeral.mourner'
    ]
  },
  {
    name: 'locations.wizardschool',
    roles: [
      'locations.roles.wizardschool.wizard',
      'locations.roles.wizardschool.witch',
      'locations.roles.wizardschool.headmaster',
      'locations.roles.wizardschool.groundskeeper',
      'locations.roles.wizardschool.potion master',
      'locations.roles.wizardschool.herbologist',
      'locations.roles.wizardschool.student'
    ]
  },

  {
    name: 'locations.olympics',
    roles: [
      'locations.roles.olympics.reporter',
      'locations.roles.olympics.athlete',
      'locations.roles.olympics.runner',
      'locations.roles.olympics.commentator',
      'locations.roles.olympics.coach',
      'locations.roles.olympics.swimmer',
      'locations.roles.olympics.spectator'
    ]
  },
...

  {
    name: 'locations.zoo',
    roles: [
      'locations.roles.zoo.zookeeper',
      'locations.roles.zoo.liontamer',
      'locations.roles.zoo.penguin',
      'locations.roles.zoo.zebra',
      'locations.roles.zoo.giraffe',
      'locations.roles.zoo.biologist',
      'locations.roles.zoo.visitor'
    ]
  },
  {
    name: 'locations.pyramids',
    roles: [
      'locations.roles.pyramids.pharao',
      'locations.roles.pyramids.high priest',
      'locations.roles.pyramids.drummer',
      'locations.roles.pyramids.architect',
      'locations.roles.pyramids.vizier',
      'locations.roles.pyramids.slavemaster',
      'locations.roles.pyramids.slave'
    ]
  },
  ...
  {
    name: 'locations.santa workshop',
    roles: [
      'locations.roles.santa workshop.santa',
      'locations.roles.santa workshop.reindeer',
      'locations.roles.santa workshop.mrs claus',
      'locations.roles.santa workshop.rudolph',
      'locations.roles.santa workshop.snowman',
      'locations.roles.santa workshop.toymaker',
      'locations.roles.santa workshop.mailman',
      'locations.roles.santa workshop.elf'
    ]
  },
  {
  ...
  {
    name: 'locations.white house',
    roles: [
      'locations.roles.white house.president',
      'locations.roles.white house.first lady',
      'locations.roles.white house.vice president',
      'locations.roles.white house.general',
      'locations.roles.white house.senator',
      'locations.roles.white house.translator',
      'locations.roles.white house.advisor',
      'locations.roles.white house.secret service'
    ]
  },
  {
